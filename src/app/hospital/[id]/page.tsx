...
export default async function HospitalPage({
  ...
  const folderMap: { [key: string]: string } = {
    ...
    'kailash-hospital-and-heart-institute-noida': 'kailash-hospital-and-heart-institute-noida',
  ...
  const getHospitalImages = (folder: string) => {
    ...
    const hospitalImages: { [key: string]: string[] } = {
      ...
      'fortis-hospital-noida': ['fortis-hospital-noida-1.jpg', 'fortis-hospital-noida-2.jpg', 'fortis-hospital-noida-3.jpg'],
      ...
      'jaypee-hospital-noida' : ['jaypee-hospital-noida-1.jpg','jaypee-hospital-noida-2.jpg','jaypee-hospital-noida-3.jpg'],
      'yatharth-super-specialty-hospital-greater-noida' : ['yatharth-super-specialty-hospital-greater-noida-1.jpg','yatharth-super-specialty-hospital-greater-noida-2.jpg','yatharth-super-specialty-hospital-greater-noida-3.jpg'],
      'kailash-hospital-and-heart-institute-noida' : ['kailash-hospital-and-heart-institute-noida-1.jpg','kailash-hospital-and-heart-institute-noida-2.jpg','kailash-hospital-and-heart-institute-noida-3.jpg'],
      'sarvodaya-hospital-faridabad' : ['sarvodaya-hospital-faridabad-1.jpg','sarvodaya-hospital-faridabad-2.jpg','sarvodaya-hospital-faridabad-3.jpg'],
