                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <p className="text-gray-600 mb-3">
                        📍 {hospital.location?.city || 'Unknown City'}, {hospital.location?.country || 'Unknown Country'}
                      </p>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Our Global Presence</h2>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {pageData.locations.map((location, i) => {
                const color = getCardColor(i);
                return (
                  <div key={i} className={`bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg border border-white/20 ${color.bg}`}>
                    ...
                    />
                    <h3 className={`text-xl font-bold mb-2 ${color.text}`}>{location.name}</h3>
                    <p className="text-gray-600">{location.hospitals} Hospitals</p>
                  </div>
                );
              })}
            </div>
