...
export default function ServicesSection({ services }: ServicesSectionProps) {
  const getIcon = (iconName: string) => {
    ...
    return icons[iconName] || icons.medical;
  };
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.list.map((service, index) => (
            <div key={index} className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 hover:shadow-xl transition-all duration-300 border border-white/20 hover:border-blue-200">
        ...
        <div className="text-center mt-12">
          <Link
            href="/chat"
            className="inline-flex items-center px-8 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors duration-200 text-lg"
          >
